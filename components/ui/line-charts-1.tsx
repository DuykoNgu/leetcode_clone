...
function ChartTooltipContent({
  ...
  active?: boolean;
  payload?: { name?: string; value?: number; dataKey?: string; color?: string; fill?: string; payload?: Record<string, unknown> }[];
  label?: string;
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      return <div className={cn("font-medium", labelClassName as string)}>{labelFormatter(value, payload)}</div>;
    }
