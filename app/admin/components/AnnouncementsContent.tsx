  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Quản lý thông báo</h2>
          <p className="text-sm text-slate-500 mt-1">Đăng, sửa, xóa thông báo hệ thống</p>
        </div>
        <Button size="sm" onClick={openCreateModal} className="bg-blue-600 hover:bg-blue-700 text-white font-bold">
      ...
      <div className="flex flex-col gap-4">
        {isLoading ? (
          ...
          <div className="py-12 text-center text-sm font-medium text-slate-400 italic border border-dashed border-slate-200 rounded-xl">
          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex w-full gap-3">
                <Button variant="outline" onClick={() => setIsDeleteModalOpen(false)} className="flex-1 font-bold text-slate-600 hover:bg-slate-50">
                  Hủy bỏ
                </Button>
                <Button onClick={confirmDelete} className="flex-1 bg-rose-500 font-bold text-white hover:bg-rose-600 shadow-lg shadow-rose-500/20">
                  Xóa vĩnh viễn
                </Button>
              </div>
            </div>
